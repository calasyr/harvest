...
class HelpsControllerTest < ActionController::TestCase
  ...
  test "should create help" do
    assert_difference('Help.count') do
      post :create, help: { content: @help.content, context: @help.context, order: @help.order, title: @help.title }
    end
  ...
  test "should update help" do
    patch :update, id: @help, help: { content: @help.content, context: @help.context, order: @help.order, title: @help.title }
    assert_redirected_to help_path(assigns(:help))
  end
